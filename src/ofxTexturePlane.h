...
enum ofxTexturePlaneOffset {
    ...
    TEXTURE_OFFSET_TOP_LEFT_TO_CENTER,
    TEXTURE_OFFSET_TOP_RIGHT_TO_CENTER,
    TEXTURE_OFFSET_MIDDLE_LEFT,
    TEXTURE_OFFSET_MIDDLE_CENTER,
    TEXTURE_OFFSET_MIDDLE_RIGHT,
    TEXTURE_OFFSET_MIDDLE_LEFT_TO_CENTER,
    TEXTURE_OFFSET_MIDDLE_RIGHT_TO_CENTER,
    TEXTURE_OFFSET_BOTTOM_LEFT,
    TEXTURE_OFFSET_BOTTOM_CENTER,
    TEXTURE_OFFSET_BOTTOM_RIGHT,
    TEXTURE_OFFSET_BOTTOM_LEFT_TO_CENTER,
    TEXTURE_OFFSET_BOTTOM_RIGHT_TO_CENTER
};
