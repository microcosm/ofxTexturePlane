...
void ofApp::update(){
    seamlessPlane1.incrementTextureOffsetX(0.003);
    buildingPlane1.incrementTextureOffsetY(0.003);
    landscapePlane1.incrementTextureOffsetX(0.003);
    
    seamlessPlane2.setTextureOffsetX(mouseX * 0.003);
    seamlessPlane2.setTextureOffsetY(mouseY * 0.003);
    buildingPlane2.setTextureOffsetX(mouseX * 0.003);
    buildingPlane2.setTextureOffsetY(mouseY * 0.003);
    landscapePlane2.setTextureOffsetX(mouseX * 0.003);
    landscapePlane2.setTextureOffsetY(mouseY * 0.003);
    
    seamlessPlane3.incrementTextureOffsetX(-0.003);
    buildingPlane3.incrementTextureOffsetY(-0.003);
    landscapePlane3.incrementTextureOffsetX(-0.003);
}
